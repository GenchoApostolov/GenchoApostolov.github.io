...
I decided to work with a Web-safe Grayscale Color Palette in order to keep the Wire Frames as simple as possible. In a table below the image you can see which color was used for what part of the Website Wire Frames.
...
The approach I took while designing the Website Wire Frames was ''Mobile First''. In addition, nowadays all websites are expected to be Responsive. The image below illustrates the Wire Frame for the ''Home'' page on a Mobile device. 
